...
> You don't need to unzip it for the script to run. But it's a good practice in general to check a file (format, content, headers) before trying to load it in R
